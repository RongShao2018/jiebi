...
<%@ page import="com.rong.model.Out" %>
            ...
            <nav class="navbar navbar-default" role="navigation">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        <li >
                            <a href="/user/login?id=<%=request.getParameter("id")%>&password=<%=request.getParameter("password")%>">账户</a>
                        </li>
                        <li class="active">
                            <a href="/user/SkipToInout?id=<%=request.getParameter("id")%>&password=<%=request.getParameter("password")%>">记账</a>
                        </li>
                        <li>
                            <a href="/user/SkipToForms?id=<%=request.getParameter("id")%>&password=<%=request.getParameter("password")%>">报表</a>
                        </li>
                    </ul>
                    ...
                    <div style="padding: 10px 10px 10px;">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="panel-2">
                                <form class="bs-example bs-example-form" name="inform" role="form" action="/user/YesterdayInout?id=<%=request.getParameter("id")%>&password=<%=request.getParameter("password")%>" method="post">
                                    <br>
                                    <div class="input-group">
                                        <span class="input-group-addon">类别</span>

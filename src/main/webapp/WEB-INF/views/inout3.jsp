...
<div class="container">
    ...
    <div class="row clearfix">
        <div class="inner">
            ...
            <div class="input-group">
            <input type="text" class="form-control" name="sid"><span class="input-group-btn"><button class="btn btn-default" type="submit" >类别查询</button></span>
            </div>
            </form>
            </div>
            <div class="bord2">
                ...
                <li class="dropdown">
                    ...
                    <li><a href="#最近三天" tabindex="-1" data-toggle="tab">昨天</a></li>
                    <li><a href="#最近七天" tabindex="-1" data-toggle="tab">最近七天</a></li>
                    <li><a href="#最近一月" tabindex="-1" data-toggle="tab">最近一月</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu" aria-labelledby="myTabDrop1">
                    <li><a href="#低于500" tabindex="-1" data-toggle="tab">低于500</a></li>
                    <li><a href="#低于2000" tabindex="-1" data-toggle="tab">500~2000</a></li>
                    <li><a href="#高于2000" tabindex="-1" data-toggle="tab">高于2000</a></li>
                    </ul>
                </li>
                </ul>      
                <div class="tab-content">
